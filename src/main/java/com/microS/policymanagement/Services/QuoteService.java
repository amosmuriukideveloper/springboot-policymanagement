...
public class QuoteService {
    ...
    private static final double STAMP_DUTY = 40;
    ...
    public Quote calculateQuote(String makeModel, int manufactureYear, Policy policy, CoverageType coverageType, PolicyType policyType, Set<CoverageOptions> coverageOptions) {
        ...
        // Apply additional levies and duties
        double totalPremium = premium;

        totalPremium += EXCESS_PROTECTOR_LEVY;
        totalPremium += TERRORISM_LEVY;
        totalPremium += COURTESY_CAR_LEVY;
        totalPremium += STAMP_DUTY;

        quote.setTotalPremium(BigDecimal.valueOf(totalPremium));
